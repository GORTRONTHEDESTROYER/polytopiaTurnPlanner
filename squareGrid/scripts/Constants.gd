...
enum UnitType {NONE, DELETE, WARRIOR, RIDER, ARCHER, DEFENDER, SWORDSMAN, KNIGHT, CATAPULT, MINDBENDER, GIANT}
enum BuildingType {NONE, DELETE, ROAD, RUIN, VILLAGE, CITY}
